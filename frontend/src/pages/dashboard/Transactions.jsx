...
const Transactions = () => {
    return (
        <div className="flex items-center justify-center min-h-[200px] bg-slate-800/50 backdrop-blur-xl border border-teal-500/20 rounded-xl p-6">
            <p className="text-gray-300 text-lg font-medium text-center">
                You don't have any successful transaction yet.
            </p>
        </div>
    )
}
