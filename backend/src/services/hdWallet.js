...
async function deriveAddressByNetwork(network, index) {
    ...
    switch (network.toUpperCase()) {
        case "BTC": return deriveBTCAddress(finalIndex);
        case "ETH":
        case "USDT":
        case "USDC": return deriveETHAddress(finalIndex);
        case "TRX":
        case "TRC": return deriveTRXAddress(finalIndex);
        case "SOL": return deriveSOLAddress(finalIndex);
