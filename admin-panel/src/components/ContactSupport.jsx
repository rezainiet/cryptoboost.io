...
const ContactSupport = () => {
        ...
        async (page = 1, status = "all", limit = submissionsPerPage) => {
            ...
            try {
                ...
                const response = await fetch(
                    `https://api.cryptoboost.network/api/contact-form/admin/form-submissions?${params.toString()}`,
    ...
    const updateStatus = useCallback(
        async (id, newStatus) => {
            try {
                const response = await fetch(`https://api.cryptoboost.network/api/contact-form/admin/form-submissions/${id}`, {
                    method: "PATCH",
